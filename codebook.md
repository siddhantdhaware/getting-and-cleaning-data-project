...
* `*mean*` - the means of the data
* `*std*` - the standard deviation of the data
* `activityName` - the activity the subject is doing at that time
* `activityNumber` - the id of the activity, as described in activity_labels.txt
